...
namespace Monashee\Recaptcha\Plugin\CMS\Controller\Page;
...
class AdvertisePost
{
    ...
    public function aroundExecute(
        \Magento\Customer\Controller\Account\AdvertisePost $subject,
        \Closure $proceed
    ) {
    ...
    protected function recaptchaError(): \Magento\Framework\Controller\Result\Redirect
    {
        ...
        $resultRedirect->setPath('cms/page/advertise');
