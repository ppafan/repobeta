...
namespace Monashee\Recaptcha\Plugin\Inquiry\Controller\Index;
...
class AdvertisePost
{
     ...
     * Execute around post
     *
     * @param \Magento\Inquiry\Controller\Index\AdvertisePost $subject
     * @param \Closure $proceed
     * @return \Magento\Framework\Controller\Result\Redirect|mixed
     */
    public function aroundExecute(
        \Magento\Inquiry\Controller\Index\AdvertisePost $subject,
        \Closure $proceed
    ) {
    ...
    protected function recaptchaError(): \Magento\Framework\Controller\Result\Redirect
    {
        ...
        $resultRedirect->setPath('inquiry/index/advertise');
