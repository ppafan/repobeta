...
class ServicesPost
{
     ...
     * Execute around post
     *
     * @param \Magento\Inquiry\Controller\Index\ServicesPost $subject
     * @param \Closure $proceed
     * @return \Magento\Framework\Controller\Result\Redirect|mixed
     */
    public function aroundExecute(
        \Magento\Inquiry\Controller\Index\ServicesPost $subject,
        \Closure $proceed
    ) {
    ...
    protected function recaptchaError(): \Magento\Framework\Controller\Result\Redirect
    {
        ...
        $resultRedirect->setPath('inquiry/index/services');
