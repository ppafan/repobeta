		...
		$services = [
			...
			/*------------------ Services child ------------------*/
				...
				$carmaintenance = [
					...
					'url' => '/services/index/carmaintenance',
					'is_active' => 0
				];
				...
				$partsinstallation = [
					...
					'url' => '/services/index/partsinstallation',
					'is_active' => 0
				];
				...
				$carcareanddetailing = [
					...
					'url' => '/services/index/carcaredetailing',
					'is_active' => 0
				];
				...
				$partsfinder = [
					...
					'url' => '/services/index/partsfinder',
					'is_active' => 0
				];
				...
				$buysellyourcar = [
					...
					'url' => '/services/index/buysell',
					'is_active' => 0
				];

				$inquirenow = [
					'name' => __('Inquire Now'),
					'id' => 'services-inquirenow',
					'url' => '/services/index/services',
					'is_active' => 0
				];
...
//			$toolsgarage 				= new Node($toolsgarage, 'id', $tree, $menu);
		...
		$servicesnode 	= new Node($services, 'id', $tree, $menu);
			...
			$inquirenow 			= new Node($inquirenow, 'id', $tree, $menu);
			/*------*/
...
//			$partsnode->addChild($toolsgarage);
		...
		$menu->addChild($servicesnode);
			...
			$servicesnode->addChild($inquirenow);
			/*------*/
