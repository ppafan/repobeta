...
namespace Autosupplyph\Inquiry\Helper;
...

{
    ...
    const XML_PATH_EMAIL_TEMPLATE_FIELD  = 'inquiry/cars/cartemplate';
    ...
    */
    ...
    public function yourCustomMailSendMethod($emailtemplatefield,$emailTemplateVariables,$senderInfo,$receiverInfo)

    {



        $this->temp_id = $this->getTemplateId($emailtemplatefield);
